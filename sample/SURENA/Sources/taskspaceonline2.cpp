...
MatrixXd TaskSpaceOnline2::PelvisTrajectory(double time, int n, double localtiming){
    double N;
    double t;
    double xp;
    double yp;
...
MatrixXd TaskSpaceOnline2::AnkleTrajectory(double time,int n, double localtiming,bool RFT_state,bool LFT_state){
