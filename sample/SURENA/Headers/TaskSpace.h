...
{public:
    ...
    double _XDesiredVelocityKH;
    double _auxilliaryStepLength;
    double _offsetOfStepLength;
    double _auxilliaryStepDuration;
    double _offsetOfStepDuration;
    int _nSteps;
    ...
    MatrixXd InitialDCM;
    MatrixXd InitialCoM;
    MatrixXd InitialCoMds;
    MatrixXd _error;
    double _pelvisLength;
    double _maxXDCMOffset;
    double _minXDCMOffset;
    double _maxYDCMOffset;
    double _doubleSupportRatio;
    double _DCMxFinalDoubleSupport;
    double _DCMxInitialDoubleSupport;
    double _DCMVelxInitialDoubleSupport;
    double _DCMVelxFinalDoubleSupport;

    double _DCMyFinalDoubleSupport;
    double _DCMyInitialDoubleSupport;
    double _DCMVelyInitialDoubleSupport;
    double _DCMVelyFinalDoubleSupport;
    MatrixXd _coefYDCMDoubleSupport;
    MatrixXd _coefXDCMDoubleSupport;
    double timeDs;
public:
    TaskSpace();
    ...
    QVector<double> DCMdsXVector;
    QVector<double> DCMdsYVector;
    QVector<double> CoMdsXVector;
    QVector<double> CoMdsYVector;
...
//private:
    ...
    double GetDoubleSupportRatio();
    void  SetDoubleSupportRation( double doubleSupportRatio);
