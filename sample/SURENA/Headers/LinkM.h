...
public:
    ...
    LinkM(QString name, int IDofLink, int IDofSyster, int IDofChild, int IDofMother, double AngleOfJoint, MatrixXd LocalAxisVectorOfJoint, MatrixXd PositionRelative2ParentOfJoint, MatrixXd CenterOfMassLocal, MatrixXd attitudeInWorldCoordinate, MatrixXd momentumOfInertia, double Mass);
    ...
    Vector3d AngularVelocityInWorldCoordinate;
     Vector3d CenterOfMassInWorldCoordinate;
